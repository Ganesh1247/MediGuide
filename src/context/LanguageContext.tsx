...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    medical_intelligence_map: "Medical Intelligence Map",
    auto_detecting: "Auto-detecting facilities within",
  ...
  te: {
    ...
    how_it_works_desc: "మా సిస్టమ్ మీ లక్షణాలను క్లినికల్ మార్గదర్శకాలకు మ్యాప్ చేయడానికి అధునాతన NLP మరియు మెషిన్ లెర్నింగ్‌ను ఉపయోగిస్తుంది. ప్రతి సెషన్ సురక్షితమైనది మరియు మీకు అవసరమైన సంరక్షణ స్థాయిని నిర్ణయించడంలో సహాయపడుతుంది.",
    ...
    emergency_desc: "మీరు లేదా మరెవరైనా తక్షణ ప్రమాదంలో ఉంటే, ఈ సాధనాన్ని ఉపయోగించవద్దు. వెంటనే 108కి కాల్ చేయండి లేదా సమీపంలోని ఈఆర్ కి వెళ్లండి.",
    launch_emergency_btn: "అత్యవసర కేంద్రాన్ని ప్రారంభించండి",
    footer_tagline: "ప్రపంచంలోనే అత్యంత అధునాతన AI-మొదటి ఆరోగ్య సంరక్షణ పోర్టల్. క్లినికల్ డేటా మరియు రోగి సంరక్షణ మధ్య అంతరాన్ని తగ్గించడం.",
    system_health_title: "సిస్టమ్ ఆరోగ్యం",
    all_systems_go: "అన్ని సిస్టమ్స్ సిద్ధంగా ఉన్నాయి",
    system_latency_desc: "మెడిగైడ్ కోర్ నోడ్‌లు గరిష్ట సామర్థ్యంతో పనిచేస్తున్నాయి. రియల్ టైమ్ డయాగ్నోస్టిక్ లాటెన్సీ: 12ms.",
    updated_ago: "4 నిమిషాల క్రితం అప్‌డేట్ చేయబడింది",
    copyright: "© 2024 మెడిగైడ్ సిస్టమ్స్. అన్ని హక్కులు ప్రత్యేకించబడ్డాయి.",
    gdpr_compliant: "GDPR కంప్లైంట్",
    aes_encryption: "256-బిట్ AES",
    initialize_checkup: "తనిఖీని ప్రారంభించండి",
    sos_center: "SOS సెంటర్",
    ...
    hello_greeting: "నమస్కారం! నేను మీ మెడిగైడ్ క్లినికల్ AI అసిస్టెంట్ ని.",
